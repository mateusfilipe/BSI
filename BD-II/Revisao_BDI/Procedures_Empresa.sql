...
delimiter ;
call inserirProjeto('Projeto Tal', 3377, 'Rua dos Bobos', 5);
select * from projeto;

#Inserir em Dependente
delimiter $$
	create procedure inserirDependente(in fcpf varchar(11), in nome_dependente varchar(11), in sexo char, in dataNasc char(10), in parentesco varchar(8))
    begin
		insert Dependente values (fcpf, nome_dependente, sexo, dataNasc, parentesco);
    end $$
delimiter ;
select * from dependente;
call inserirDependente('12345678966', 'Maria', 'F', '02-02-2002', 'filha');
